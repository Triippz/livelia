...
var user_repository_1 = require("@api/users/repositories/user.repository");
...
var UserService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createUserDto;
                        return [4 /*yield*/, (0, bcryptjs_1.hash)(createUserDto.password, 10)];
                    case 1:
                        _a.password = _b.sent();
    ...
    UserService.prototype.updateEmail = function (id, email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userRepository.updateEmail(id, email)];
            });
        });
    };
    UserService.prototype.validateEmailAndPassword = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
